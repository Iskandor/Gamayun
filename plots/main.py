...
def atari_env(plots=True, tables=True):
    config_dpm = [
        ...
        {'env': 'montezuma', 'algorithm': 'ppo', 'model': 'dpm', 'id': 'v2m1h4', 'legend': 'DPM v2m1h4'},
        {'env': 'montezuma', 'algorithm': 'ppo', 'model': 'dpm', 'id': 'v3m1h4', 'legend': 'DPM v3m1h4'},
        {'env': 'montezuma', 'algorithm': 'ppo', 'model': 'dpm', 'id': 'v3m2h4', 'legend': 'DPM v3m2h4'},
        {'env': 'montezuma', 'algorithm': 'ppo', 'model': 'dpm', 'id': 'v3m2h8', 'legend': 'DPM v3m2h8'},
        {'env': 'montezuma', 'algorithm': 'ppo', 'model': 'dpm', 'id': 'v3m2h16', 'legend': 'DPM v3m2h16'},
        {'env': 'montezuma', 'algorithm': 'ppo', 'model': 'dpm', 'id': 'v3m3h4', 'legend': 'DPM v3m3h4'},
