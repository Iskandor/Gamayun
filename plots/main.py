...
def atari_env(plots=True, tables=True):
    ...
    plot('montezuma_v5m', config, labels=['external reward', 'forward reward', 'forward space', 'forward target space'], keys=['re', 'forward_reward', 'forward_space', 'target_forward_space'], plot_details=['seer_asym_v9m1'], window=10000)
