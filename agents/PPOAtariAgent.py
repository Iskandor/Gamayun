...
class PPOAtariAgent(PPOAgent):
    ...
    def train(self, agent_state):
        ...
        self.memory.add(state=agent_state.state.cpu(), value=agent_state.value.cpu(), action=agent_state.action.cpu(), prob=agent_state.probs.cpu(), reward=agent_state.reward.cpu(), mask=agent_state.done.cpu())
...
class PPOAtariSNDAgent(PPOAtariAgent):
    ...
    def train(self, agent_state):
        ...
        self.memory.add(state=agent_state.state.cpu(), value=agent_state.value.cpu(), action=agent_state.action.cpu(), prob=agent_state.probs.cpu(), reward=agent_state.reward.cpu(), mask=agent_state.done.cpu())
        self.motivation_memory.add(state=agent_state.state.cpu(), next_state=agent_state.next_state.cpu(), action=agent_state.action.cpu(), done=agent_state.done.cpu())
