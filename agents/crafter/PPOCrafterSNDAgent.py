...
from modules.carfter.PPOCrafterNetworkSND import PPOCrafterNetworkSND
from motivation.SNDMotivation import SNDMotivationFactory


class PPOCrafterSNDAgent(PPOAtariAgent):
    def __init__(self, config):
        super().__init__(config)
        self.model = PPOCrafterNetworkSND(config).to(config.device)
