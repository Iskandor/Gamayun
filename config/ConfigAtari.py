...
from agents.atari.PPOAtariFMMultiStepAgent import PPOAtariFMMultiStepAgent
...
from modules.forward_models.HiddenModel import HiddenModelType
...
class ConfigMontezumaFMSTDIM_0_01_32_128(ConfigAtari):
    def __init__(self, num_threads, device, shift, path):
        super().__init__(env_name='MontezumaRevengeNoFrameskip-v4',
                         steps=32,
                         lr=1e-4,
...
class ConfigMontezumaFMSTDIM_32_feature_dim_4096(ConfigAtari):
    def __init__(self, num_threads, device, shift, path):
        super().__init__(env_name='MontezumaRevengeNoFrameskip-v4',
                         steps=32,
                         lr=1e-4,
...
class ConfigMontezumaFMSTDIM_128_feature_dim_4096(ConfigAtari):
    def __init__(self, num_threads, device, shift, path):
        super().__init__(env_name='MontezumaRevengeNoFrameskip-v4',
                         steps=128,
                         lr=1e-4,
...
class ConfigMontezumaFMSTDIM_32_feature_dim_4096_skip_connection(ConfigAtari):
    def __init__(self, num_threads, device, shift, path):
        super().__init__(env_name='MontezumaRevengeNoFrameskip-v4',
                         steps=32,
                         lr=1e-4,
...
class ConfigMontezumaFMLinearNoiseSTDIM_32_feature_dim_1024(ConfigAtari):
    def __init__(self, num_threads, device, shift, path):
        super().__init__(env_name='MontezumaRevengeNoFrameskip-v4',
                         steps=32,
                         lr=1e-4,
    ...
    def train(self, trial):
        ...
        agent = PPOAtariFMLinearAgent(self, forward_model_type=ForwardModelType.ForwardModelNoiseSkipConnection, type=10)
        agent.training_loop(self.env, name, trial)


class ConfigMontezumaFMLinearNoiseWithNoiseResidualSTDIM_32_feature_dim_1024(ConfigAtari):
    def __init__(self, num_threads, device, shift, path):
        super().__init__(env_name='MontezumaRevengeNoFrameskip-v4',
                         steps=32,
                         lr=1e-4,
...
class ConfigMontezumaFMLinearNoiseWithActionEmbeddingSTDIM_32_feature_dim_1024(ConfigAtari):
    def __init__(self, num_threads, device, shift, path):
        super().__init__(env_name='MontezumaRevengeNoFrameskip-v4',
                         steps=32,
                         lr=1e-4,
    ...
    def train(self, trial):
        ...
        agent = PPOAtariFMLinearAgent(self, forward_model_type=ForwardModelType.ForwardModelLinearResidualWithoutAction, type=5)
        agent.training_loop(self.env, name, trial)


class ConfigMontezumaFMLinearSTDIM_32_feature_dim_4096_WithActionProjection_SKIP(ConfigAtari):
    def __init__(self, num_threads, device, shift, path):
        super().__init__(env_name='MontezumaRevengeNoFrameskip-v4',
                         steps=32,
                         lr=1e-4,
...
class ConfigMontezumaFMLinearSTDIM_128_feature_dim_1024_WithActionProjection_SKIP(ConfigAtari):
    def __init__(self, num_threads, device, shift, path):
        super().__init__(env_name='MontezumaRevengeNoFrameskip-v4',
                         steps=128,
                         lr=1e-4,
...
class ConfigMontezumaFMLinearSTDIM_32_feature_dim_1024_WithActionProjection2_SKIP(ConfigAtari):
    def __init__(self, num_threads, device, shift, path):
        super().__init__(env_name='MontezumaRevengeNoFrameskip-v4',
                         steps=32,
                         lr=1e-4,
...
class ConfigMontezumaFMIJEPA_Skip_Hidden_Model_Delta_0_1(ConfigAtari):
    def __init__(self, num_threads, device, shift, path):
        super().__init__(env_name='MontezumaRevengeNoFrameskip-v4',
                         steps=32,
                         lr=1e-4,
    ...
    def train(self, trial):
        ...
        agent = PPOAtariFMAgent(self, _type = ArchitectureType.I_JEPA, forward_model_type=ForwardModelType.ForwardModelSkipConnection, 
                                hidden_model_type=HiddenModelType.HiddenModelSkipConnection)
        agent.training_loop(self.env, name, trial)


class ConfigMontezumaFMIJEPA_Skip_Hidden_Model_Delta_0_01(ConfigAtari):
    def __init__(self, num_threads, device, shift, path):
        super().__init__(env_name='MontezumaRevengeNoFrameskip-v4',
                         steps=32,
                         lr=1e-4,
...
class ConfigMontezumaFMLinearNoiseWithNoiseResidualSTDIM_32(ConfigAtari):
    def __init__(self, num_threads, device, shift, path):
        super().__init__(env_name='MontezumaRevengeNoFrameskip-v4',
                         steps=32,
                         lr=1e-4,
...
class ConfigMontezumaFMLinearNoiseWithNoiseResidualSTDIM_32_WithSemanticLoss(ConfigAtari):
    def __init__(self, num_threads, device, shift, path):
        super().__init__(env_name='MontezumaRevengeNoFrameskip-v4',
                         steps=32,
                         lr=1e-4,
...
class ConfigMontezumaFMLinearNoiseWithNoiseResidualSTDIM_32_EncoderGELU(ConfigAtari):
    def __init__(self, num_threads, device, shift, path):
        super().__init__(env_name='MontezumaRevengeNoFrameskip-v4',
                         steps=32,
                         lr=1e-4,
...
class ConfigMontezumaFMMultiStep_Horizon_32_STDIM_32(ConfigAtari):
    def __init__(self, num_threads, device, shift, path):
        super().__init__(env_name='MontezumaRevengeNoFrameskip-v4',
                         steps=32,
                         lr=1e-4,
...
class ConfigMontezumaFMSTDIM_128_feature_dim_512(ConfigAtari):
    def __init__(self, num_threads, device, shift, path):
        super().__init__(env_name='MontezumaRevengeNoFrameskip-v4',
                         steps=128,
                         lr=1e-4,
...
class ConfigMontezumaFMLinearNoiseWithNoiseResidualSTDIM_128_feature_dim_1024(ConfigAtari):
    def __init__(self, num_threads, device, shift, path):
        super().__init__(env_name='MontezumaRevengeNoFrameskip-v4',
                         steps=128,
                         lr=1e-4,
...
class ConfigMontezumaFMTrulyLinearSTDIM_128_feature_dim_1024(ConfigAtari):
    def __init__(self, num_threads, device, shift, path):
        super().__init__(env_name='MontezumaRevengeNoFrameskip-v4',
                         steps=128,
                         lr=1e-4,
...
class ConfigMontezumaFMTrulyLinear2STDIM_128_feature_dim_1024(ConfigAtari):
    def __init__(self, num_threads, device, shift, path):
        super().__init__(env_name='MontezumaRevengeNoFrameskip-v4',
                         steps=128,
                         lr=1e-4,
